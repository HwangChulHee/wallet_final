...
export default function Completion() {
    ...
    return (
        <>
            ...
            <div className='card-container'>
                <div className='h-w-p-80 h-flex h-flex-col h-items-center'>
                    <h2 className='h-my-4'>지갑 생성 성공</h2>
                    <div className='h-text-center h-mb-8'>
                    지갑을 성공적으로 보호했습니다. 비밀 복구 구문을 안전하게 비밀로 유지하세요. 이는 귀하의 책임입니다.
                    </div>

                    <div className='h-w-full li_div'>
                        <span style= {{marginLeft:'0.6rem'}}>참고:</span>            
                        <ul>
                        <li>알바트로스는 비밀 복구 구문을 복구할 수 없습니다.</li>
                        <li>알바트로스는 비밀 복구 구문을 절대 묻지 않습니다.</li>
                    ...
                    <div className='btn-group h-mb-4'>
                        <button onClick={() => goTo(Make_account)} className='h-mb-2'>확인했습니다.</button>
                    </div>
                </div>                
            </div>
        </>
